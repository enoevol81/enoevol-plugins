...
2. Data/config/secrets -> ASK
3. Regenerable artifact -> CUT (if the regenerating command exists, else ASK)
4. Unreachable + zero references + old on both clocks -> QUARANTINE
5. Anything else (recent, doc-referenced, large, weird) -> ASK
